...
const PreviewSignatureCreator = ({ userName, signature }: Props) => {
  return (
    <Fragment>
      <View style={styles.detailsContainer}>
        <View style={styles.col1}>
          <DetailsItem title="Generated by" content={userName} />
          <DetailsItem title="On behalf of" content={userName} />
        </View>
...
export default PreviewSignatureCreator;
