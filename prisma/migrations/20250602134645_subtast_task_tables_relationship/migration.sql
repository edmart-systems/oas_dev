...
-- AlterTable
ALTER TABLE `sub_task` MODIFY `priorityId` INTEGER NULL DEFAULT 2,
...
-- AddForeignKey
ALTER TABLE `sub_task` ADD CONSTRAINT `sub_task_taskId_fkey` FOREIGN KEY (`taskId`) REFERENCES `task`(`taskId`) ON DELETE RESTRICT ON UPDATE CASCADE;
